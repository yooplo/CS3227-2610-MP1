...
final class WatchedView extends VBox {
    ...
    WatchedView(MovieTrackerApplicationService applicationService,
        ...
        movieList.setCellFactory(ignored -> new WatchedCell(
                movieSelectionHandler, this::removeFromWatched));
    ...
    private void removeFromWatched(TrackedMovie trackedMovie) {
        ...
        removalTask.setOnSucceeded(event -> {
            ...
            String message = removalTask.getValue()
                    ...
                    : "That movie is no longer in Watched.";
    ...
    private static final class WatchedCell extends ListCell<TrackedMovie> {
        ...
        protected void updateItem(TrackedMovie trackedMovie, boolean empty) {
            ...
            remove.setAccessibleText("Remove " + movie.getTitle() + " from Watched");
